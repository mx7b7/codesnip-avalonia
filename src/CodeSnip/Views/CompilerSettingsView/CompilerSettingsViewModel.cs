...
public partial class CompilerSettingsViewModel : ObservableObject, IOverlayViewModel
{
    ...
    [ObservableProperty] private ObservableCollection<CompilerInfo> _compilers = [];

    [ObservableProperty] private CompilerInfo? _selectedCompiler;

    [ObservableProperty] private bool _isAddingLanguage;

    [ObservableProperty] private bool _canSetDefaultCompiler;

    [ObservableProperty] private string _compilersLink = string.Empty;

    [ObservableProperty] private string _linkText = string.Empty;

    // edit/insert
    [ObservableProperty] private string _compilerLocalId = string.Empty;
    [ObservableProperty] private string _compilerId = string.Empty;
    [ObservableProperty] private string _compilerName = string.Empty;
    [ObservableProperty] private string _compilerFlags = string.Empty;

    [ObservableProperty] private bool _canSaveCompiler;
